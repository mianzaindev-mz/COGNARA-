# ================================================================
# COGNARA Demo Seed Builder — Clean 3-User Edition
# Users: Admin, Coach Muhammad Zain, Student Daniyal Ahmad
# Run:   python build_clean_script.py
# Output: presentation_demo_combined_seed.sql
# ================================================================
import os
...
output_path = os.path.join(script_dir, "presentation_demo_combined_seed.sql")

with open(output_path, "w", encoding="utf-8") as f:
    f.write(sql_content)

print(f"Generated {output_path}")
print("3-user demo seed: Admin, Coach Zain, Student Daniyal")
print("Courses: Python(8L), WebDev(7L), ML(7L), Cyber(4L) = 26 lessons total")
print("Daniyal progress: Python 75%, WebDev 43%, ML 29%, Cyber 25%")
