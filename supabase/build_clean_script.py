# Python script to write the complete, corrected and self-contained combined seed data SQL script.
import os
...
with open("c:/GitHub/COGNARA/supabase/presentation_demo_combined_seed.sql", "w", encoding="utf-8") as f:
    f.write(sql_content)

print("Generated presentation_demo_combined_seed.sql with fallback course creation and safety EXISTS checks.")
