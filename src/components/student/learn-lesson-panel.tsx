      ...
      <div className="flex-1 flex relative overflow-hidden mt-4">
        {isMobile ? (
          ...
          >
            ...
            <div className="min-h-[380px] bg-white border border-cn-border rounded-[1.5rem] p-7 shadow-sm dark:bg-[#12100f] dark:border-stone-850">
              <TabContent
                leftTab={leftTab}
                lesson={lesson}
                ctx={ctx}
          ...
          <>
            <div
              ...
              className="flex flex-col h-full min-w-[420px] overflow-y-auto pr-4 pb-20 scrollbar-thin select-none"
            >
              <div className="relative h-[clamp(260px,38vh,430px)] w-full overflow-hidden rounded-[1.75rem] border border-cn-border bg-gradient-to-br from-cn-lavender/30 via-cn-canvas to-cn-yellow/20 dark:border-[#2e2a2a] shrink-0 mb-4 shadow-sm">
                {renderVideoPlayer()}
              </div>
              <TabBar leftTab={leftTab} setLeftTab={setLeftTab} />
              <div className="min-h-[380px] bg-white border border-cn-border rounded-[1.5rem] p-7 shadow-sm dark:bg-[#12100f] dark:border-stone-850">
